...
public Payment getPayment() {
	...
	public BigDecimal calcChange() {
		if(this.calcAmtTendered().subtract(getTotalPayments()).compareTo(new BigDecimal(0))==-1){
			return new BigDecimal(0);
		}
		return this.calcAmtTendered().subtract(getTotalPayments());
	
//		BigDecimal change= new BigDecimal("0");
//		System.out.println("\n the change amount to be paid:");
//		input=new Scanner(System.in);
//	BigDecimal Change=getTotalPayments().subtract(amtTendered);
//		
